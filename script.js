...
const writingTasks = [
    { text: "ამოხსენით ექსტრემალუირი ამოცანა", img: "images/0.png" },
    { text: "იპოვეთ a-ს მნიშვნელობა, რომლისთვისაც f(x) ფუნქცია იქნება მოდალური [a,40] შუალედში, პასუხი დაასაბუთე", img: "images/1.png" },
    { text: "ლაგრანჟის ფუნქციის გამოყენებით ამოხსენით ამოცანა", img: "images/2.png" },
    { text: "შეამოწმეთ ამოზნექილია თუ არა სიმრავლე", img: "images/3.png" },
    { text: "ამოხსენით ექსტრემალუირი ამოცანა", img: "images/4.png" },
    { text: "f(x;y) ამოცანაში X0=(2;0) საწყისი წერტილი და a0=0,5 ბიჯით განახორციელეთ გრადიენტული დაშვების ერთი ბიჯი და შეადარეთ ერთმანეთს f(x0) და f(x1)", img: "images/5.png" },
    { text: "ლაგრანჟის ფუნქციის გამოყენებით ამოხსენით ამოცანა", img: "images/6.png" }
];
